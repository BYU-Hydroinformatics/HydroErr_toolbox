function ret_value = h3_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H3 Error (H3 (RMSHE)) for simulated and 
% observed data.
%   metric = h3_rmshe(sim, obs) Calculates the H3 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h3_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H3 (RMSHE) 

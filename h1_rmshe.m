function ret_value = h1_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H1 Error (H1 (RMSHE)) for simulated and 
% observed data.
%   metric = h1_rmshe(sim, obs) Calculates the H1 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h1_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H1 (RMSHE) 

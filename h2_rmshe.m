function ret_value = h2_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H2 Error (H2 (RMSHE)) for simulated and 
% observed data.
%   metric = h2_rmshe(sim, obs) Calculates the H2 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h2_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H2 (RMSHE) 

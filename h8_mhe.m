function ret_value = h8_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H8 Error (H8 (MHE)) for simulated and 
% observed data.
%   metric = h8_mhe(sim, obs) Calculates the H8 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h8_mhe(sim, obs, remove_zero, remove_neg) Calculates the H8 (MHE) 

function ret_value = me( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Error (ME) for simulated and 
% observed data.
%   metric = me(sim, obs) Calculates the ME error metric between the
%   simulated and observed data.
%
%   metric = me(sim, obs, remove_zero, remove_neg) Calculates the ME 

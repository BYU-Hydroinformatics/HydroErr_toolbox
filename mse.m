function ret_value = mse( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Squared Error (MSE) for simulated and 
% observed data.
%   metric = mse(sim, obs) Calculates the MSE error metric between the
%   simulated and observed data.
%
%   metric = mse(sim, obs, remove_zero, remove_neg) Calculates the MSE 

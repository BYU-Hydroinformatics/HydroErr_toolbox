function ret_value = h3_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H3 Error (H3 (MAHE)) for simulated and 
% observed data.
%   metric = h3_mahe(sim, obs) Calculates the H3 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h3_mahe(sim, obs, remove_zero, remove_neg) Calculates the H3 (MAHE) 

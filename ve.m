function ret_value = ve( sim, obs, remove_zero, remove_neg )
% Calculates the Volumetric Efficiency (VE) for simulated and 
% observed data.
%   metric = ve(sim, obs) Calculates the VE error metric between the
%   simulated and observed data.
%
%   metric = ve(sim, obs, remove_zero, remove_neg) Calculates the VE 

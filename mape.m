function ret_value = mape( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute Percentage Error (MAPE) for simulated and 
% observed data.
%   metric = mape(sim, obs) Calculates the MAPE error metric between the
%   simulated and observed data.
%
%   metric = mape(sim, obs, remove_zero, remove_neg) Calculates the MAPE 

function ret_value = ed( sim, obs, remove_zero, remove_neg )
% Calculates the Eclidean Distance (ED) for simulated and 
% observed data.
%   metric = ed(sim, obs) Calculates the ED error metric between the
%   simulated and observed data.
%
%   metric = ed(sim, obs, remove_zero, remove_neg) Calculates the ED 

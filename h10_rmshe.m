function ret_value = h10_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H10 Error (H10 (RMSHE)) for simulated and 
% observed data.
%   metric = h10_rmshe(sim, obs) Calculates the H10 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h10_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H10 (RMSHE) 

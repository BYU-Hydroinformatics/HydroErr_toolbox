function ret_value = h8_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H8 Error (H8 (MAHE)) for simulated and 
% observed data.
%   metric = h8_mahe(sim, obs) Calculates the H8 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h8_mahe(sim, obs, remove_zero, remove_neg) Calculates the H8 (MAHE) 

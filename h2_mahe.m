function ret_value = h2_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H2 Error (H2 (MAHE)) for simulated and 
% observed data.
%   metric = h2_mahe(sim, obs) Calculates the H2 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h2_mahe(sim, obs, remove_zero, remove_neg) Calculates the H2 (MAHE) 

function ret_value = h1_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H1 Error (H1 (MHE)) for simulated and observed data.
%   metric = h1_mhe(sim, obs) Calculates the H1 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h1_mhe(sim, obs, remove_zero, remove_neg) Calculates the H1 (MHE) 

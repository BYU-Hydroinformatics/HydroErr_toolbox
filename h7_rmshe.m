function ret_value = h7_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H7 Error (H7 (RMSHE)) for simulated and 
% observed data.
%   metric = h7_rmshe(sim, obs) Calculates the H7 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h7_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H7 (RMSHE) 
...
switch nargin
    case 2
        ...
        % Computing the H7 (RMSHE)
        h = (sim ./ obs - 1) / min(sim ./ obs);

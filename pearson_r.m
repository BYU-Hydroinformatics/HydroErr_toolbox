function ret_value = pearson_r( sim, obs, remove_zero, remove_neg )
% Calculates the Pearson Correlation Coefficient (R (Pearson)) for simulated and 
% observed data.
%   metric = pearson_r(sim, obs) Calculates the R (Pearson) error metric between the
%   simulated and observed data.
%
%   metric = pearson_r(sim, obs, remove_zero, remove_neg) Calculates the R (Pearson) 
...
switch nargin
    case 2
        ...
        % Computing the R (Pearson)
        ret_value = corr(sim, obs);

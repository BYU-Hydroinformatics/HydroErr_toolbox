function ret_value = mdse( sim, obs, remove_zero, remove_neg )
% Calculates the Median Squared Error (MdSE) for simulated and 
% observed data.
%   metric = mdse(sim, obs) Calculates the MdSE error metric between the
%   simulated and observed data.
%
%   metric = mdse(sim, obs, remove_zero, remove_neg) Calculates the MdSE 

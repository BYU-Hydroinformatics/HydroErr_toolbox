function ret_value = mapd( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute Percentage Deviation (MAPD) for simulated and 
% observed data.
%   metric = mapd(sim, obs) Calculates the MAPD error metric between the
%   simulated and observed data.
%
%   metric = mapd(sim, obs, remove_zero, remove_neg) Calculates the MAPD 

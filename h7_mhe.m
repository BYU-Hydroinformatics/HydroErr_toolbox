function ret_value = h7_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H7 Error (H7 (MHE)) for simulated and 
% observed data.
%   metric = h7_mhe(sim, obs) Calculates the H7 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h7_mhe(sim, obs, remove_zero, remove_neg) Calculates the H7 (MHE) 

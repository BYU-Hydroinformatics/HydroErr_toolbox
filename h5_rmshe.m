function ret_value = h5_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H5 Error (H5 (RMSHE)) for simulated and 
% observed data.
%   metric = h5_rmshe(sim, obs) Calculates the H5 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h5_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H5 (RMSHE) 

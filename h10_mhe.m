function ret_value = h10_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H10 Error (H10 (MHE)) for simulated and 
% observed data.
%   metric = h10_mhe(sim, obs) Calculates the H10 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h10_mhe(sim, obs, remove_zero, remove_neg) Calculates the H10 (MHE) 

function ret_value = h2_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H2 Error (H2 (MHE)) for simulated and 
% observed data.
%   metric = h2_mhe(sim, obs) Calculates the H2 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h2_mhe(sim, obs, remove_zero, remove_neg) Calculates the H2 (MHE) 

function ret_value = h3_mhe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean H3 Error (H3 (MHE)) for simulated and 
% observed data.
%   metric = h3_mhe(sim, obs) Calculates the H3 (MHE) error metric between the
%   simulated and observed data.
%
%   metric = h3_mhe(sim, obs, remove_zero, remove_neg) Calculates the H3 (MHE) 

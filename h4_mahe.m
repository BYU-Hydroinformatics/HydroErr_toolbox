function ret_value = h4_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H4 Error (H4 (MAHE)) for simulated and 
% observed data.
%   metric = h4_mahe(sim, obs) Calculates the H4 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h4_mahe(sim, obs, remove_zero, remove_neg) Calculates the H4 (MAHE) 

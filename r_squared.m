function ret_value = r_squared( sim, obs, remove_zero, remove_neg )
% Calculates the Coefficient of Determination (r2) for simulated and 
% observed data.
%   metric = r_squared(sim, obs) Calculates the r2 error metric between the
%   simulated and observed data.
%
%   metric = r_squared(sim, obs, remove_zero, remove_neg) Calculates the r2 

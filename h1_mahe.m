function ret_value = h1_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H1 Error (H1 (MAHE)) for simulated and 
% observed data.
%   metric = h1_mahe(sim, obs) Calculates the H1 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h1_mahe(sim, obs, remove_zero, remove_neg) Calculates the H1 (MAHE) 

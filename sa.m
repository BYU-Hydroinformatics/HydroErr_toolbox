function ret_value = sa( sim, obs, remove_zero, remove_neg )
% Calculates the Spectral Angle (SA) for simulated and 
% observed data.
%   metric = sa(sim, obs) Calculates the SA error metric between the
%   simulated and observed data.
%
%   metric = sa(sim, obs, remove_zero, remove_neg) Calculates the SA 

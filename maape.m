function ret_value = maape( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Arctangent Absolute Percentage Error (MAAPE) for simulated and 
% observed data.
%   metric = maape(sim, obs) Calculates the MAAPE error metric between the
%   simulated and observed data.
%
%   metric = maape(sim, obs, remove_zero, remove_neg) Calculates the MAAPE 

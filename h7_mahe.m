function ret_value = h7_mahe( sim, obs, remove_zero, remove_neg )
% Calculates the Mean Absolute H7 Error (H7 (MAHE)) for simulated and 
% observed data.
%   metric = h7_mahe(sim, obs) Calculates the H7 (MAHE) error metric between the
%   simulated and observed data.
%
%   metric = h7_mahe(sim, obs, remove_zero, remove_neg) Calculates the H7 (MAHE) 

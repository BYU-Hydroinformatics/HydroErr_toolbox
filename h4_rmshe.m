function ret_value = h4_rmshe( sim, obs, remove_zero, remove_neg )
% Calculates the Root Mean Square H4 Error (H4 (RMSHE)) for simulated and 
% observed data.
%   metric = h4_rmshe(sim, obs) Calculates the H4 (RMSHE) error metric between the
%   simulated and observed data.
%
%   metric = h4_rmshe(sim, obs, remove_zero, remove_neg) Calculates the H4 (RMSHE) 
